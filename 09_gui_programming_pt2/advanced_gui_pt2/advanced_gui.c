...
void configure_text_input_box(AdvancedGUI* app) {
    ...
    text_input_set_result_callback(
        app->text_input, text_input_callback, app, app->input, TEXT_BUFFER_SIZE, true);
...
int32_t run_flipper_application(AdvancedGUI* app) {
    ...
    configure_text_input_box(app);
    configure_view_dispatcher(app);
    configure_widget(app);
